  ...
  return (
    ...
    <div className='w-full h-full grid md:grid-cols-3 grid-rows-none  justify-items-between py-20 px-8 gap-4 '>
        ...
        <div className='flex flex-col'>
            <h1 className='text-center text-2xl lg:text-4xl font-semibold text-black italic border-b-[1px] border-black'>Gravid/föräldraskap</h1>
        ...
        <div className='flex flex-col'>
            <h1 className='text-center text-2xl lg:text-4xl font-semibold text-black italic border-b-[1px] border-black'>Trauma</h1>
        ...
        <div className='flex flex-col'>
            <h1 className='text-center text-2xl lg:text-4xl font-semibold text-black italic border-b-[1px] border-black'>Terapi</h1>
